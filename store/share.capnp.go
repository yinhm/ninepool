...
func NewShare(s *C.Segment) Share       { return Share(s.NewStruct(24, 7)) }
func NewRootShare(s *C.Segment) Share   { return Share(s.NewRootStruct(24, 7)) }
...
func (s Share) Ntime() int64            { return int64(C.Struct(s).Get64(16)) }
func (s Share) SetNtime(v int64)        { C.Struct(s).Set64(16, uint64(v)) }
func (s Share) Nonce() string           { return C.Struct(s).GetObject(6).ToText() }
func (s Share) SetNonce(v string)       { C.Struct(s).SetObject(6, s.Segment.NewText(v)) }
...
func NewShareList(s *C.Segment, sz int) Share_List { return Share_List(s.NewCompositeList(24, 7, sz)) }
