...
func NewPrefix(s *C.Segment) Prefix      { return Prefix(s.NewStruct(8, 0)) }
func NewRootPrefix(s *C.Segment) Prefix  { return Prefix(s.NewRootStruct(8, 0)) }
...
func (s Prefix) Unixtime() int32         { return int32(C.Struct(s).Get32(4)) }
func (s Prefix) SetUnixtime(v int32)     { C.Struct(s).Set32(4, uint32(v)) }
...
func NewPrefixList(s *C.Segment, sz int) Prefix_List { return Prefix_List(s.NewUInt64List(sz)) }
